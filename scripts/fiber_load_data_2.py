...
#%%
# load the images
inp_folder = '../data2/data_fiber/Input/Input_20Fiber_grid128_2000cases_generalized.mat'
out_folder = '../data2/data_fiber/Output/Output_20Fiber_grid128_2000cases_UnitAxialAndShear.mat'
...
save_path = "../figures2/figures_fiber/example.png"
...
df.to_csv("../data2/data_fiber/train_val_test_split.csv", index=False)
#%%
# Save to disk
np.save("../data2/data_fiber/X_tr.npy", X_tr)
np.save("../data2/data_fiber/X_val.npy", X_val)
np.save("../data2/data_fiber/X_ts.npy", X_ts)
np.save("../data2/data_fiber/Y_tr.npy", Y_tr)
np.save("../data2/data_fiber/Y_val.npy", Y_val)
np.save("../data2/data_fiber/Y_ts.npy", Y_ts)
# %%
